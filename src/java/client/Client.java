...
public class Client extends MediaLibraryGUI implements TreeWillExpandListener, ActionListener, TreeSelectionListener {
    ...
    public Client(String author, String serviceURL, String host, int port) {
        super(author);
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Handling exception: " + e.getMessage());
        }
    ...
    public void buildInitialTree(DefaultMutableTreeNode root, String base) {
        try {
            ...
            JOptionPane.showMessageDialog(this, "exception initial tree:" + e);
            e.printStackTrace();
        }
    }
    ...
    public void rebuildTree() {
        ...
        for (int i = 0; i < musicList.length; i++) {
            ...
            if (subNode != null) {
                ...
                debug("Adding subcategory: aSubCat");
    ...
    private DefaultMutableTreeNode getSubLabelled(DefaultMutableTreeNode root, String label) {
        ...
        for (Enumeration en = root.children(); en.hasMoreElements(); ) {
            next = (DefaultMutableTreeNode) en.nextElement();
            debug("Subcategory with label: " + (String)next.getUserObject());
            if (((String) next.getUserObject()).equals(label)) {
                debug("Found subcategory with label: " + label);
                found = true;
                break;
            }
        }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("Exit")) {
            ...
            boolean success = this.add(typeJCB.getSelectedIndex(), titleJTF.getText(), authorJTF.getText(), genreJTF.getText(), albumJTF.getText(), fileNameJTF.getText());
            if (success) {
            ...
            try {
                ...
                String mediaFileName = (typeJCB.getSelectedIndex() == 0) ? "DataClient/mediafile.mp3" : "DataClient/mediafile.mp4";
    ...
    public boolean add(int mtype, String title, String author, String genre, String album, String filename) {
        boolean result = false;
        try {
            String jsonString = packageMediaCall("Add");
            String insert = ",\"params\":[" + mtype + ",\"" + title + "\",\"" + author + "\",\"" + genre + "\",\"" + album + "\",\"" + filename + "\"]";
    ...
    //The getTitles method attempts to get the titles of all MediaDescriptions on the server.
